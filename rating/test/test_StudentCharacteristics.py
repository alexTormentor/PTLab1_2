...
@pytest.mark.parametrize("input_data, expected_result", [
    ...
    ({"Иванов": 75.0, "Петров": 75.0, "Сидоров": 75.0}, ["Иванов", "Петров", "Сидоров"]), # Словарь рейтингов с несколькими студентами, все с одинаковым рейтингом
    ({"Иванов": 0.0, "Петров": 0.0, "Сидоров": 0.0, "Абрамов": 0.0}, ["Иванов", "Петров", "Сидоров", "Абрамов"]),
